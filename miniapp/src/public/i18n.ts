  ...
  personalPlans: [
    {
      ...
      cta: "Get Started",
      groups: "3 SCANS / DAY",
      features: ["3 scan/day", "Scan files, links", "Community support"],
    },
    {
      id: "personal_pro",
      name: "Pro",
      ...
      features: ["200 scans per month", "Scan files, links", "Priority support"],
    },
    {
      id: "personal_premium",
      name: "Premium",
      ...
      features: ["400 scans per month", "Everything in Pro", "Community support"],
    },
  ],
  businessPlans: [
    {
...
const km: typeof en = {
  ...
  personalPlans: [
    { id: "starter", 
      ...
      badge: null, 
      cta: "ចាប់ផ្តើម", 
      groups: "ស្កែន ៣ ដង/ថ្ងៃ", 
      features: [ "ស្កែន ៣ ដង/ថ្ងៃ", "ស្កែនឯកសារ និងតំណភ្ជាប់", "ការគាំទ្រពីសហគមន៍", ], },
    { id: "pro", 
      name: "វិជ្ជាជីវៈ", 
      price: "$5.99", 
      period: "ក្នុងមួយខែ", 
      ...
      badge: "ពេញនិយមបំផុត", 
      cta: "ដំឡើងទៅ Pro", 
      groups: "ស្កែនរហូតដល់ ២០០ ដង/ខែ", 
      features: [ "ស្កែន ២០០ ដងក្នុងមួយខែ", "ស្កែនឯកសារ និងតំណភ្ជាប់", "ការគាំទ្រជាអាទិភាព", ], },
    { id: "premium", 
      name: "ពិសេស", 
      price: "$9.99", 
      period: "ក្នុងមួយខែ", 
      ...
      badge: null, 
      cta: "ដំឡើងទៅ Premium", 
      groups: "ស្កែន ៤០០ ដង/ខែ", 
      features: [ "ស្កែន ៤០០ ដងក្នុងមួយខែ", "អ្វីៗទាំងអស់ក្នុងកញ្ចប់វិជ្ជាជីវៈ",  "ការគាំទ្រពីសហគមន៍", ], }, ],
  businessPlans: [ 
    { id: "starter", 
      name: "ចាប់ផ្តើម", 
      price: "$8", 
